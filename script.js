  ...
  {},
  {
    scrollTrigger: {
      ...
      onUpdate: self => {
        ...
        const midStart = 0.4;
        const midEnd = 0.6;
        if (self.progress < start) index = 0;else
        if (self.progress > end) index = COMPLETES.length - 1;else
        if (self.progress > midStart && self.progress < midEnd) {
          index = 6;
  ...
  timeline({
    scrollTrigger: {
      ...
      onUpdate: self => {
        ...
        const end = 0.5;
        if (self.progress < start) index = 0;else
        if (self.progress > end) index = GOBBLERS.length - 1;else
